...
import main.oauth.exceptions.OAuthConnectionException;
import main.oauth.exceptions.OAuthException;
import main.oauth.utils.ParameterList;
...
public class OAuthRequest
{
  ...
  OAuthResponse doSend() throws IOException
  {
    ...
    return new OAuthResponse(connection);
  }
